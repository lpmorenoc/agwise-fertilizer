...
#merge_DSSAT_output <- function(country, useCaseName,Crop, AOI,season){
  ...
  if (AOI==TRUE){
    saveRDS(f_all, file = paste0("/home/jovyan/agwise-potentialyield/dataops/potentialyield/Data/useCase_", country, "_",useCaseName, "/", Crop, "/result/DSSAT/useCase_", country, "_",useCaseName, "_", Crop,"_AOI_season_",season,".rds"))
