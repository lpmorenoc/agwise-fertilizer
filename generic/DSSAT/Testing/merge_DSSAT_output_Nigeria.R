...
merge_DSSAT_output_nigeria <- function(country, useCaseName, Crop, AOI = FALSE, season = NULL, varietyid, zone_folder = TRUE, level2_folder = FALSE) {
  ...
  if (AOI == TRUE) {
    saveRDS(results, file = paste0(dir_path, "useCase_", country, "_", useCaseName, "_", Crop, "_AOI_season_", season,"_",varietyid, ".RDS"))
  }else{
    saveRDS(results, file = paste0(dir_path, "useCase_", country, "_", useCaseName, "_", Crop, "_fieldData_season_", season,"_",varietyid, ".RDS"))
  }
