...
readGeo_CM_zone <- function(country, useCaseName, Crop, AOI = FALSE, season=1, zone){
  ...
  if(AOI == TRUE){
    Rainfall <- readRDS(paste(pathIn, "Rainfall_Season_", season, "_PointData_AOI.RDS", sep=""))[c(5001:10000),]
      #cat("Rain done")
    SolarRadiation <- readRDS(paste(pathIn, "solarRadiation_Season_", season, "_PointData_AOI.RDS", sep=""))[c(5001:10000),]
    #cat("sr done")
      TemperatureMax <- readRDS(paste(pathIn, "temperatureMax_Season_", season, "_PointData_AOI.RDS", sep=""))[c(5001:10000),]
    #cat("tm done")
      TemperatureMin <- readRDS(paste(pathIn, "temperatureMin_Season_", season, "_PointData_AOI.RDS", sep=""))[c(5001:10000),]
    #cat("tmin done")
    ...
    # cat("rh done")
      Soil <- readRDS(paste(pathIn,"SoilDEM_PointData_AOI_profile.RDS", sep=""))[c(5001:10000),]
  }else{
