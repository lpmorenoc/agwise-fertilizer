...
#   }
#   
  dssat_oni<-readRDS("~/agwise-potentialyield/dataops/potentialyield/Data/useCase_Ghana_Esoko/Maize/result/DSSAT/AOI/useCase_Ghana_Esoko_Maize_AOI_season_1_ONI.RDS")
  dssat_oni<-dssat_oni[dssat_oni$Loc=='Upper West',]
  ## 4.5. Basic plots ####
  if (Plot == TRUE){
    ### 4.5.1. Global plot ####
