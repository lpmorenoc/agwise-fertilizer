...
varietyids <- main_Crop_varietyid
...
script_to_source <- switch(cropping_system,
                           monocrop = "/home/jovyan/patricia_repos/agwise-fertilizer/generic/APSIM/05_MONOCROP_produce_APSIM_plots.R",
                           intercrop = "/home/jovyan/patricia_repos/agwise-fertilizer/generic/APSIM/05_INTERCROP_produce_APSIM_plots.R",
                           rotation = "/home/jovyan/patricia_repos/agwise-fertilizer/generic/APSIM/05_ROTATION_produce_APSIM_plots.R")
...
arguments <- switch(cropping_system,
                    monocrop = list(
                      ...
                      useCaseName = useCaseName, Crop = main_Crop,
